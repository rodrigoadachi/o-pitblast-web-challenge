...
export const CardData = ({ user }: { user?: iUser }) => {
  return (
    <div className="rounded-3xl bg-white hover:bg-gray-100 w-1/4 shadow-xl ackdrop-blur-md backdrop-filter backdrop-blur-8 flex flex-col items-start justify-start p-10">
